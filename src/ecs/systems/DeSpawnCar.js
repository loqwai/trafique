...
export class DeSpawnCar extends System {
  ...
  _maybeDeSpawn = (entity) => {
    ...
    if (rotationCloseTo(car.rotation, Math.PI, 0.1) && car.position.y < bottom) return // going down
    if (rotationCloseTo(car.rotation, 0, 0.1) && car.position.y > top) return // going up
